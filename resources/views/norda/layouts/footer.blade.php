            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-6 col-md-6">
                    <div class="payment-img payment-img-right">
                        <a href="#"><img src="{{url('design/assets/')}}images/icon-img/payment.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="col-lg-5 col-md-6 col-12 col-sm-12">
                        <div class="tab-content quickview-big-img">
                            <div id="pro-1" class="tab-pane fade show active">
                                <img src="{{url('design/assets/')}}images/product/product-1.jpg" alt="">
                            </div>
                            <div id="pro-2" class="tab-pane fade">
                                <img src="{{url('design/assets/')}}images/product/product-3.jpg" alt="">
                            </div>
                            <div id="pro-3" class="tab-pane fade">
                                <img src="{{url('design/assets/')}}images/product/product-6.jpg" alt="">
                            </div>
                        ...
                        <div class="quickview-wrap mt-15">
                            <div class="quickview-slide-active nav-style-6">
                                <a class="active" data-toggle="tab" href="#pro-1"><img src="{{url('design/assets/')}}images/product/quickview-s1.jpg" alt=""></a>
                                <a data-toggle="tab" href="#pro-2"><img src="{{url('design/assets/')}}images/product/quickview-s2.jpg" alt=""></a>
                                <a data-toggle="tab" href="#pro-3"><img src="{{url('design/assets/')}}images/product/quickview-s3.jpg" alt=""></a>
...
<script src="{{url("design/assets")}}/js/vendor/vendor.min.js"></script>
<script src="{{url("design/assets")}}/js/plugins/plugins.min.js"></script> 
<!-- Main JS -->
