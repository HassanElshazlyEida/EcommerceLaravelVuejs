                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-2">
                            <div class="logo">
                                <a href="index.html"><img src="{{Storage::url(setting()->logo)}}" alt="logo"></a>
                            </div>
                        </div>
                                            ...
                                            <ul class="mega-menu-style mega-menu-mrg-1">
                                                <li>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="shop.html"><img src="{{url('design/assets')}}/images/banner/banner-12.png" alt=""></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <ul>
                                            <li class="cr-dropdown"><a href="#">Clothing <span class="icon-arrow-right"></span></a>
                                                <div class="category-menu-dropdown ct-menu-res-height-1">
                                                    ...
                                                    <div class="single-category-menu">
                                                        <a href="product-details.html"><img src="{{url('design/assets')}}/images/menu/menu-categori-1.png" alt=""></a>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <li class="cr-dropdown"><a href="#">Men <span class="icon-arrow-right"></span></a>
                                                <div class="category-menu-dropdown ct-menu-res-height-1">
                                                    ...
                                                    <div class="single-category-menu">
                                                        <a href="#"><img src="{{url('design/assets')}}/images/menu/menu-categori-1.png" alt=""></a>
                                                    </div>
                                                </div>
                                            </li>
